(function (root, factory) {
  ...
  if (typeof define === 'function' && define.amd) {
    ...
    function _storageProvider(storageType) {
        return function () {
          var storageKeyPrefix = 'panda-';

          this.setKeyPrefix = function (prefix) {
            if (typeof prefix !== 'string') {
              throw new TypeError('[panda] - ' + storageType + 'Provider.setKeyPrefix() expects a String.');
            }
          ...
          this.setSerializer = function (s) {
            if (typeof s !== 'function') {
              throw new TypeError('[panda] - ' + storageType + 'Provider.setSerializer expects a function.');
            }
          ...
          this.setDeserializer = function (d) {
            if (typeof d !== 'function') {
              throw new TypeError('[panda] - ' + storageType + 'Provider.setDeserializer expects a function.');
            }
